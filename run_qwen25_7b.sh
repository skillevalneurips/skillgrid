#!/bin/bash
# Run Qwen2.5-7B-Instruct on AIME24, AIME25, and AMC23 sequentially
# Usage: CUDA_VISIBLE_DEVICES=1 ./run_qwen25_7b.sh
...
MODEL="qwen25_7b_instruct_vllm"
LOG_DIR="logs"

mkdir -p "$LOG_DIR"

echo "=========================================="
echo "Starting Qwen2.5-7B-Instruct experiments"
...
echo ""
echo "=========================================="
echo "Qwen2.5-7B-Instruct experiments complete!"
echo "=========================================="
